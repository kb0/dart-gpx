...
enum AltitudeMode { absolute, clampToGround, relativeToGround }
    ...
    if (value != null) {
      builder.element(
        ...
        nest: () {
          builder.element(
            KmlTagV22.when,
            nest: value.toUtc().toIso8601String(),
          );
        },
      );
    }
